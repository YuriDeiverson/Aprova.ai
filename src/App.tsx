...
export default function App() {
  ...
  const planExists = localStorage.getItem('custom_study_sections') !== null;
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans flex flex-col">
      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-50 shadow-xs">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              <div className="w-10 h-16 flex items-center justify-center">
                <div className="w-8 h-8 rounded-lg bg-indigo-600 flex items-center justify-center text-white font-extrabold shadow-sm">
                  {activeCourse === 'tecnico_enfermagem' ? 'E' : activeCourse === 'jornalismo' ? 'J' : 'I'}
                </div>
              </div>
            ...
            {/* Overall Progress Mini KPI Panel (Desktop Only) */}
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex-grow w-full flex flex-col space-y-6">
        ...
        {/* Navigation Tabs Bar - Only show if plan exists */}
        {planExists && (
        ...
        <div className="flex-grow transition-all duration-300">
          ...
          {planExists && activeTab === 'study' && <StudyTab />}
          {planExists && activeTab === 'quiz' && <QuizTab />}
          {planExists && activeTab === 'schedule' && <ScheduleTab />}
        </div>
      </main>
