...
export const COURSES_CONFIG: {
  ...
  seplag_informatica: {
    ...
    description: "Concurso para Especialista em Gestão Pública (Tecnologia da Informação e Informática). Foco em Engenharia de Software, DevOps, Banco de Dados, Redes e Legislação de Alagoas.",
    topics: [
    ...
    quizQuestions: [
      {
        ...
        text: 'A teoria do Gatekeeping postula que as notícias são selecionadas por filtros e decisores (gatekeepers) dentro das redações, os quais decidem quais fatos se tornarão públicos e quais serão descartados.',
        correct: 'Certo',
      ...
      },
      {
        id: 2,
        category: 'Teoria da Comunicação',
        text: 'A hipótese do Agenda-Setting defende que a mídia possui um poder irrestrito de manipulação direta de opinião, ditando aos indivíduos exatamente as ideologias em que eles devem acreditar.',
        correct: 'Errado',
      ...
      },
      {
        ...
        text: 'O lead jornalístico tradicional é composto pelas respostas a seis perguntas fundamentais: Quem? O quê? Quando? Onde? Como? Por quê? Ele deve vir na abertura do texto de notícia.',
        correct: 'Certo',
      ...
      },
      {
        id: 4,
        category: 'Técnicas de Redação',
        text: 'A estrutura da pirâmide invertida consiste em apresentar o clímax da matéria de forma literária somente nas conclusões do último parágrafo, mantendo o suspense nas linhas anteriores.',
        correct: 'Errado',
      ...
      },
      {
        ...
        text: 'No âmbito da assessoria de imprensa corporativa, o "media training" é o treinamento dado aos executivos e porta-vozes da empresa para que aprendam a se relacionar de forma adequada, assertiva e segura com os veículos de comunicação.',
        correct: 'Certo',
      ...
      },
      {
        id: 6,
        category: 'Assessoria de Imprensa',
        text: 'Ao lidar com uma situação de crise institucional grave, a recomendação clássica das boas assessorias de comunicação é que a instituição adote o silêncio irrestrito ("sem declarações") para evitar vazamento de dados.',
        correct: 'Errado',
      ...
      },
      {
        ...
        text: 'No webjornalismo, a escrita voltada para SEO (Search Engine Optimization) ignora completamente a utilidade de palavras-chave, priorizando exclusivamente títulos poéticos e metafóricos para a atração do leitor.',
        correct: 'Errado',
      ...
      },
      {
        id: 8,
        category: 'Jornalismo Digital',
        text: 'O hipertexto é uma característica marcante do jornalismo digital que permite ao leitor uma leitura não-linear, expandindo a matéria com links e conexões externas ao longo do texto.',
        correct: 'Certo',
        explanation: 'O hipertexto permite que o leitor acesse informações complementares de forma interativa e não sequencial, clicando em links espalhados pelo texto principal.'
      },
      {
        id: 9,
        category: 'Ética e Compliance',
        text: 'Constitucionalmente, no Brasil, o sigilo da fonte jornalística é garantido quando necessário ao exercício profissional, não sendo permitido ao juiz exigir a revelação do nome da fonte sob pena de violação constitucional.',
        correct: 'Certo',
      ...
      },
      {
        id: 10,
        category: 'Ética e Compliance',
        text: 'O Código de Ética dos Jornalistas Brasileiros proíbe expressamente a divulgação de notícias que firam os direitos humanos ou promovam o ódio, devendo o jornalista ouvir as partes envolvidas antes de publicar denúncias.',
        correct: 'Certo',
      ...
      },
      {
        id: 12,
        category: 'Assessoria de Imprensa',
        text: 'A clipagem é utilizada por assessorias de imprensa e empresas especializadas para monitorar a cobertura e as menções sobre a instituição nos meios de comunicação.',
        correct: 'Certo',
      ...
      },
      {
        id: 13,
        category: 'Assessoria de Imprensa',
        text: 'Mailing de imprensa consiste no acompanhamento e arquivamento de notícias publicadas na imprensa, realizado por meio de recortes ou cópias digitais.',
        correct: 'Errado',
      ...
      },
      {
        id: 14,
        category: 'Técnicas de Redação',
        text: 'O emprego de linguagem complexa nos textos jornalísticos institucionais valoriza a imagem da organização perante o público, realçando a importância técnica de suas ações de pesquisa.',
        correct: 'Errado',
      ...
      },
      {
        id: 15,
        category: 'Técnicas de Redação',
        text: 'O editorial é o gênero jornalístico caracterizado por expressar a opinião oficial do veículo de comunicação diante de fatos de grande repercussão nacional ou internacional.',
        correct: 'Certo',
      ...
      },
      {
        ...
        text: 'De acordo com o Marco Legal da CT&I (Lei nº 13.243/2016) e a Lei nº 10.973/2004, a Encomenda Tecnológica (ETEC) é um instrumento de fomento que envolve risco tecnológico e dispensa de licitação para a contratação de pesquisa e desenvolvimento.',
        correct: 'Certo',
      ...
      },
      {
        id: 17,
        category: 'Marco Legal de CT&I',
        text: 'Segundo a Lei Estadual nº 8.956/2023 de Alagoas, a FAPEAL integra a estrutura do Sistema Estadual de CT&I e atua como principal agência pública de fomento à pesquisa e bolsas de pós-graduação.',
        correct: 'Certo',
      ...
      },
      {
        ...
        text: 'O Manual de Oslo define inovação como a introdução de um produto (bem ou serviço) novo ou significativamente melhorado, ou de um processo, ou de um novo método de marketing ou método organizacional.',
        correct: 'Certo',
      ...
      },
      {
        id: 19,
        category: 'Divulgação Científica',
        text: 'A análise bibliométrica, muito utilizada na divulgação científica de órgãos de fomento, consiste na aplicação de métodos estatísticos para analisar o padrão de publicações, citações e o fator de impacto de periódicos.',
        correct: 'Certo',
      ...
      },
      {
        id: 20,
        category: 'Divulgação Científica',
        text: 'Em consonância com a Lei de Acesso à Informação (LAI), a divulgação espontânea de relatórios públicos de fomento e guias do proponente nos portais das fundações de amparo à pesquisa configura uma ação de transparência passiva.',
        correct: 'Errado',
...
export function generateCustomPlan(
  ...
  const filteredQuestions = config.quizQuestions.filter((q: any) => {
    ...
    return categoriesToInclude.some(catTitle => 
      ...
      (course === 'seplag_informatica' && q.category === 'Ética e Compliance' && selectedTopicIds.includes('etica')) ||
      (course === 'seplag_informatica' && q.category === 'Conhecimentos de Alagoas' && selectedTopicIds.includes('alagoas')) ||
  ...
  const questionsToUse = filteredQuestions.length > 0 ? filteredQuestions : config.quizQuestions;
  ...
  // Determine study distribution. Let's say we have N topics/sections
  const totalHoursAvailable = studyDaysCount * hoursPerDay;
  ...
  for (let w = 1; w <= numWeeks; w++) {
    ...
    // Select 1 or 2 topics for this week
    ...
    blocks.push({
      ...
      duration: `${Math.ceil(hoursPerTopic * 0.4)}h`,
    ...
    blocks.push({
      ...
      duration: `${Math.ceil(hoursPerTopic * 0.6)}h`,
    ...
    generatedWeeks.push({
      ...
      focus: `Revisão do edital de Pareto de ${activeSectionForWeek.title}. Restam ${Math.max(0, daysRemaining - (w - 1) * 7)} dias até a prova.`,
      blocks: blocks
    });
  }
